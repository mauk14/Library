...
type DB interface {
	...
	Get(ctx context.Context, query string, id interface{}, collection string, scope string) (interface{}, error)
	...
	Delete(ctx context.Context, query string, id int64, collection string, scope string) error
